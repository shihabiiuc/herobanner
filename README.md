# Create a hero section only using HTML CSS
This repository is a part of my blog post [Shihabiiuc.Com/BannerHTML](https://shihabiiuc.com/hero-banner-image-using-html-css/)

This is a plain HTML & CSS template available for download.

_Check the blog post to learn how I built this template only using HTML & CSS._

### See live page (GitHub Pages)
:rocket: [Live page link](https://shihabiiuc.github.io/herobanner/)
